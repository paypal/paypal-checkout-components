...
export function getInlineWalletComponent() {
    return inlineMemoize(getInlineWalletComponent, () => {
        return create({
            tag:    'paypal-inline-wallet',
            url:    () => `${ getPayPalDomain() }${ __PAYPAL_CHECKOUT__.__URI__.__INLINE_WALLET__ }`,
