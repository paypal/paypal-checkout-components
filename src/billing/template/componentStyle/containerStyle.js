...
export function getContainerStyle({ id, tag, CONTEXT, CLASS, ANIMATION } : { id : string, tag : string, CONTEXT : Object, CLASS : Object, ANIMATION : Object }) : string {
    return `
        ...
        #${ id } .paypal-checkout-close-inner {
            display: block;
        }
        ...
        @media screen and (max-width: 470px) {
            ...
            #${ id } #paypal-checkout-close-inner:hover {
                opacity: 1;
            }

            #${ id } #paypal-checkout-close-inner:before, #${ id } #paypal-checkout-close-inner:after {
                position: absolute;
                left: 15px;
                content: ' ';
                height: 30px;
            ...
            #${ id } #paypal-checkout-close-inner:before {
                transform: rotate(45deg);
                -webkit-transform: rotate(45deg);
                -moz-transform: rotate(45deg);
                -o-transform: rotate(45deg);
            ...
            #${ id } #paypal-checkout-close-inner:after {
                transform: rotate(-45deg);
                -webkit-transform: rotate(-45deg);
                -moz-transform: rotate(-45deg);
                -o-transform: rotate(-45deg);
