...
import { getGrabpayConfig } from './grabpay';
...
export function getFundingConfig() : { [$Values<typeof FUNDING>] : ?FundingSourceConfig } {
    return inlineMemoize(getFundingConfig, () => {
        return {
            ...
            [ FUNDING.GRABPAY ]:        (!__TREE_SHAKE__ || (typeof __FUNDING_ELIGIBILITY__.grabpay !== 'undefined'        && __FUNDING_ELIGIBILITY__.grabpay.eligible)) ? getGrabpayConfig() : null
        };
    });
}
