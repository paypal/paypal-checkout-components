...
export function getCreditConfig(): FundingSourceConfig {
  return {
    ...
    eligible: ({ fundingEligibility, experiment, createVaultSetupToken }) => {
      return experiment?.paypalCreditButtonCreateVaultSetupTokenExists
        ? Boolean(createVaultSetupToken)
        : Boolean(fundingEligibility?.credit?.eligible);
    },
