...
export const componentContent : ContentMap = {
    en: {
        ...
        Donate:             ({ logo }) => <Fragment>{ logo }<Text optional> Donate</Text></Fragment>
    },
    fr: {
        ...
        Donate:    ({ logo }) => <Fragment>{ logo }<Text optional> Faire un don</Text></Fragment>
    },
    es: {
        ...
        Donate:             ({ logo }) => <Fragment>{ logo }<Text optional> Donar</Text></Fragment>
    },
    zh: {
        ...
        Donate:    ({ logo }) => <Fragment>{ logo }<Text optional> 捐赠</Text></Fragment>
    },
    ar: {
        ...
        Donate:    ({ logo }) => <Fragment>{ logo }<Text optional> تبرع </Text></Fragment>
    },
    de: {
        ...
        Donate:    ({ logo }) => <Fragment>{ logo }<Text optional> Spenden</Text></Fragment>
    },
    nl: {
        ...
        Donate:    ({ logo }) => <Fragment>{ logo }<Text optional> Doneren</Text></Fragment>
    },
    pt: {
        Checkout:           ({ logo }) => <Fragment>{ logo }<Text optional> Checkout</Text></Fragment>,
        ...
        Donate:             ({ logo }) => <Fragment>{ logo }<Text optional> Doar</Text></Fragment>
    },
    cs: {
        ...
        Donate:    ({ logo }) => <Fragment>{ logo }<Text optional> Přispět</Text></Fragment>
    },
    da: {
        ...
        Donate:    ({ logo }) => <Fragment>{ logo }<Text optional> Doner</Text></Fragment>
    },
    ru: {
        ...
        Donate:    ({ logo }) => <Fragment>{ logo }<Text optional> Сделать пожертвование</Text></Fragment>
    },
    fi: {
        ...
        Donate:    ({ logo }) => <Fragment>{ logo }<Text optional> Lahjoita</Text></Fragment>
    },
    el: {
        ...
        Donate:    ({ logo }) => <Fragment>{ logo }<Text optional> Δωρεά</Text></Fragment>
    },
    hu: {
        ...
        Donate:    ({ logo }) => <Fragment>{ logo }<Text optional> Adományozás</Text></Fragment>
    },
    id: {
        Checkout:  ({ logo }) => <Fragment>{ logo }<Text optional> Checkout</Text></Fragment>,
        ...
        Donate:    ({ logo }) => <Fragment>{ logo }<Text optional> Donasikan</Text></Fragment>
    },
    he: {
        ...
        Donate:    ({ logo }) => <Fragment>{ logo }<Text optional> שליחת תרומה</Text></Fragment>
    },
    it: {
        ...
        Donate:    ({ logo }) => <Fragment>{ logo }<Text optional> Donazione</Text></Fragment>
    },
    ja: {
        ...
        Donate:    ({ logo }) => <Fragment>{ logo }<Text optional> 寄付する</Text></Fragment>
    },
    ko: {
        ...
        Donate:    ({ logo }) => <Fragment>{ logo }<Text optional> 기부</Text></Fragment>
    },
    no: {
        Checkout:  ({ logo }) => <Fragment>{ logo }<Text optional> Betal</Text></Fragment>,
        Subscribe: ({ logo }) => <Fragment>{ logo }<Text optional> Abonner</Text></Fragment>,
    ...
    pl: {
        ...
        Donate:    ({ logo }) => <Fragment>{ logo }<Text optional> Przekaż darowiznę</Text></Fragment>
    },
    sv: {
        ...
        Donate:    ({ logo }) => <Fragment>{ logo }<Text optional> Donera</Text></Fragment>
    },
    sk: {
        ...
        Donate:    ({ logo }) => <Fragment>{ logo }<Text optional> Prispieť</Text></Fragment>
    },
    th: {
        ...
        Donate:    ({ logo }) => <Fragment>{ logo }<Text optional> บริจาค</Text></Fragment>
    },
    tr: {
