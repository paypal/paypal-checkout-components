...
export const componentContent : ContentMap = {
    ar: {
        ...
        Save:    ({ logo }) => <Fragment>{ logo }<Text animate optional> WIP </Text></Fragment>
    },
    bg: {
    ...
    en: {
        ...
        Save: ({ logo }) => <Fragment><Text animate optional>Save </Text>{logo}</Fragment>,
    },
    es: {
