...
export const buttonColorStyle = `
    ...
    .${ CLASS.BUTTON }[${ ATTRIBUTE.FUNDING_SOURCE }=${ FUNDING.PAYUPONINVOICE }].${ CLASS.COLOR }-${ BUTTON_COLOR.DEFAULT } {
        background: #2C2E2F;
    }
    ...
    .${ CLASS.BUTTON }[${ ATTRIBUTE.FUNDING_SOURCE }=${ FUNDING.PAYUPONINVOICE }].${ CLASS.COLOR }-${ BUTTON_COLOR.DEFAULT }:hover,
    ...
    .${ CLASS.BUTTON }[${ ATTRIBUTE.FUNDING_SOURCE }=${ FUNDING.PAYUPONINVOICE }].${ CLASS.COLOR }-${ BUTTON_COLOR.DEFAULT }:focus,
    ...
    .${ CLASS.BUTTON }[${ ATTRIBUTE.FUNDING_SOURCE }=${ FUNDING.PAYUPONINVOICE }].${ CLASS.COLOR }-${ BUTTON_COLOR.DEFAULT }:focus::after,
