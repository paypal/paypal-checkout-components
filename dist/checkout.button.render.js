!function(e, a) {
    ...
    "./src/button/template/componentTemplate.jsx": function(module, __webpack_exports__, __webpack_require__) {
        ...
        var FUNDING_PRIORITY = [ constants.t.PAYPAL, constants.t.VENMO, constants.t.CREDIT, constants.t.IDEAL, constants.t.ELV, constants.t.BANCONTACT, constants.t.GIROPAY, constants.t.EPS, constants.t.SOFORT, constants.t.MYBANK, constants.t.CARD ], FUNDING_CONFIG = ((_FUNDING_CONFIG = {})[constants.r] = {
            enabled: !0,
            allowOptIn: !0,
            allowOptOut: !0,
            allowRemember: !0,
        ...
        }, _fundingLogos[constants.h.CREDIT] = ((_BUTTON_LOGO$CREDIT = {})[constants.i.WHITE] = credit_white_default.a, 
        ...
        function renderCards(_ref5) {
            ...
            return cards.map(function(name) {
                ...
                return jsxToHTML("img", _extends({}, ((_ref6 = {})[constants.c.BUTTON] = button || !1, 
                _ref6[constants.c.FUNDING_SOURCE] = "" + constants.t.CARD, _ref6[constants.c.CARD] = "" + name, 
                _ref6), {
