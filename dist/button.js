...
module.exports = (function (n) {
  ...
  function (n, e, t) {
        ...
        function n(n) {
          ...
          if (
            ...
            try {
              ...
              return U(), void this.reject(n);
            }
            U(), (a = !0), r ? this.resolve(t) : l && this.reject(o);
          }
        }
        var e = n.prototype;
        return (
          ...
          (e.dispatch = function () {
            ...
            if (!this.dispatching && (e || t)) {
              ...
              (o.length = 0), (this.dispatching = !1), U();
            }
          }),
          (e.then = function (e, t) {
    ...
    var Pn = {
      ...
      _n = { BLACK: "black", WHITE: "white" },
      Un = { TOP: "top", BOTTOM: "bottom" },
      In = { CENTER: "center", LEFT: "left", RIGHT: "right" },
      Dn = "default",
      zn = {
    ...
    var Yn = Ln(function () {
      try {
        ...
        })(__SDK_HOST__, __PATH__, n);
      }
    });
    Ln(function () {
      for (var n = {}, e = 0, t = Yn().attributes; e < t.length; e++) {
        var o = t[e];
    ...
    function Xn(n) {
      ...
      function T() {
        return I.try(function () {
          if (
            ...
            for (var n = {}, e = 0; e < L.length; e++) Kn(n, (0, L[e])(n));
            for (var o, r = {}, l = 0; l < b.length; l++) Kn(r, (0, b[l])(r));
            return (
              t &&
                (o = u({
                  method: "POST",
      ...
      function B(n) {
        ...
        for (var e = 0; e < m.length; e++)
          Kn(n.dimensions || {}, (0, m[e])(n.dimensions || {}));
        return (
      ...
      var F = {
        ...
        track: function (n) {
          ...
          for (var e = On(n), t = 0; t < v.length; t++) Kn(e, (0, v[t])(e));
    ...
    var qn,
      Qn = Ln(function () {
        return Xn({
          url:
            "undefined" != typeof __DISABLE_SET_COOKIE__ &&
            __DISABLE_SET_COOKIE__
              ? Jn() + "?disableSetCookie=true"
              : Jn(),
          metricNamespacePrefix: "pp.sdks.ppcp",
        });
      });
    function $n(n, e, t, o, r, l, a) {
      try {
        var i = n[l](a),
          u = i.value;
      } catch (n) {
    ...
    var ee =
      ...
      (qn[H.STAGE] =
        "https://cdn-latest.static.engineering.dev.paypalinc.com/qaRdaAssets/fraudnet/async/fb-raw.js"),
      (qn[H.SANDBOX] = "https://c.paypal.com/da/r/fb.js"),
      (qn[H.PRODUCTION] = "https://c.paypal.com/da/r/fb.js"),
      (qn[H.TEST] = "https://c.paypal.com/da/r/fb.js"),
      qn);
    Ln(function (n) {
      var e = n.env,
        t = n.cspNonce,
      ...
      var l,
        a = (function (n) {
          ...
          Qn().warn("ppcp_axo_init_fraudnet_failed");
        });
      return {
        collect:
          ((l = ne(function* () {
            try {
              ...
              Qn().warn("ppcp_axo_collect_fraudnet_failed");
            }
          })),
          function () {
      ...
      Ln(function (n) {
        Qn().info("rest_api_create_access_token");
        var e,
          t,
          o = Cn(n + ":");
        return Rn({
            ...
            trigger: function (n) {
              ...
              if (l)
                for (
                  ...
                  i();
              return I.all(a).then(vn);
            },
            triggerOnce: function (e) {
              if (n[e]) return I.resolve();
              n[e] = !0;
              for (
      ...
      ue =
        ((oe = ne(function* () {
          if (!te) {
            ...
            te = te || { publicKey: o.publicKey, privateKey: o.privateKey };
          }
          return te;
        })),
        function () {
      ...
      pe =
        ((ae = ne(function* (n) {
          var e = n.accessToken,
            ...
            u = Ce(JSON.stringify({ alg: ie.alg, typ: "dpop+jwt", jwk: i })),
            c = {
              ath: e ? yield fe(e) : void 0,
              cnf: { jkt: yield se(i) },
              htm: t,
              htu: a,
            ...
            C = yield window.crypto.subtle.sign(ie.sign, l, ce(u + "." + d));
          return u + "." + d + "." + Ce(de(new Uint8Array(C)));
        })),
        function (n) {
    ...
    var Te,
      Oe = ["logoColor"],
      Me =
        (((Te = {}).default = { primary: "#ffffff", secondary: "#ffffff" }),
        (Te.white = { primary: "#ffffff", secondary: "#ffffff" }),
        (Te.black = { primary: "#000000", secondary: "#000000" }),
        Te);
    function Ee(n) {
    ...
    var xe,
      ...
      Be =
        ...
        xe),
      Fe = ["logoColor"],
      Ve = (((He = {}).default = { primary: "#142C8E" }), He);
    function Se(n) {
      var e = void 0 === n ? {} : n,
        t = e.logoColor,
        o = b(e, Fe),
    ...
    var De,
      ze = ["logoColor"],
      We =
        (((De = {}).default = { primary: "#333030" }),
        (De.white = { primary: "#ffffff" }),
        (De.black = { primary: "#333030" }),
        De);
    function Ye(n) {
      var e = void 0 === n ? {} : n,
        t = e.logoColor,
    ...
    var Ge,
      je = ["logoColor", "locale"],
      Ke =
        (((Ge = {}).default = { primary: "#003087" }),
        (Ge.blue = { primary: "#003087" }),
        (Ge.white = { primary: "#ffffff" }),
        (Ge.black = { primary: "#333030" }),
        Ge);
    function Xe(n) {
      var e = n.logoColor,
        t = n.locale,
        ...
        })(y({ country: t.country }, we("credit", Ke, e)));
      return f(
        ye,
        y({}, o, {
          name: "credit",
    ...
    var qe,
      ...
      rt = ["logoColor"],
      lt =
        (((qe = {}).default = { primary: "#FFFFFF", secondary: "#FFFFFF" }),
        (qe.white = { primary: "#FFFFFF", secondary: "#FFFFFF" }),
        (qe.black = { primary: "#C8036F", secondary: "#71706F" }),
        qe),
      at = ["logoColor"],
      it =
        (((Qe = {}).default = {
      ...
      ut = ["logoColor"],
      ct =
        ((($e = {}).default = { primary: "#FFFFFF", secondary: "#CC0066" }),
        ($e.white = { primary: "#FFFFFF", secondary: "#CC0066" }),
        ($e.black = { primary: "#FFFFFF", secondary: "#CC0066" }),
        $e),
      dt = ["logoColor"],
      Ct =
        (((nt = {}).default = { primary: "#00C0EE", secondary: "#FFFFFF" }),
        (nt.white = { primary: "#FFFFFF", secondary: "#FFFFFF" }),
        (nt.black = { primary: "#00C0EE", secondary: "#1A4B67" }),
        nt),
      ft = ["logoColor"],
      st =
        (((et = {}).default = { primary: "#FFFFFF", secondary: "#FFFFFF" }),
        (et.white = { primary: "#FFFFFF", secondary: "#FFFFFF" }),
        (et.black = { primary: "#B3B1B1", secondary: "#D03238" }),
        et),
      pt = ["logoColor"],
      ht = ["logoColor"],
      gt =
        (((tt = {}).default = { primary: "#003087", secondary: "#009cde" }),
        (tt.blue = { primary: "#003087", secondary: "#009cde" }),
        (tt.white = { primary: "#ffffff", secondary: "#ffffff" }),
        (tt.black = { primary: "#333030", secondary: "#636363" }),
        (tt.monochrome = { primary: "#000000", secondary: "#000000" }),
        tt);
    function Lt(n) {
      var e = n.logoColor,
    ...
    var wt,
      ...
      Mt = ["logoColor"],
      Et =
        (((wt = {}).default = { main: "#005DA0", card: "#AEB1BC" }),
        (wt.white = { main: "#FFFFFF", card: "#FFFFFF" }),
        (wt.black = { main: "#333030", card: "#333030" }),
        wt),
      At = ["logoColor"],
      xt =
        (((Tt = {}).default = { primary: "#EDEDED", secondary: "#393A41" }),
        (Tt.white = { primary: "#FFFFFF", secondary: "#000000" }),
        (Tt.black = { primary: "#393A41", secondary: "#EDEDED" }),
        Tt),
      Ht = ["logoColor"],
      Nt =
        (((Ot = {}).default = { primary: "#3D93CE" }),
        (Ot.blue = { primary: "#3D93CE" }),
        (Ot.white = { primary: "#ffffff" }),
        (Ot.black = { primary: "#333030" }),
        Ot);
    function Bt(n) {
      var e = n.logoColor,
        t = void 0 === e ? "default" : e,
    ...
    var Ft,
      ...
      zt = ["logoColor"],
      Wt =
        (((Ft = {}).default = { primary: "#ffffff" }),
        (Ft.blue = { primary: "#003087" }),
        (Ft.white = { primary: "#ffffff" }),
        (Ft.black = { primary: "#333030" }),
        Ft),
      Yt = ["logoColor"],
      Gt =
        (((Vt = {}).default = { primary: "#1AAD19", secondary: "#FFFFFF" }),
        (Vt.white = { primary: "#FFFFFF", secondary: "#FFFFFF" }),
        (Vt.black = { primary: "#1AAD19", secondary: "#4D4D4D" }),
        Vt),
      jt = ["logoColor"],
      Kt =
        (((St = {}).default = { primary: "#A6C307" }),
        (St.white = { primary: "#FFFFFF" }),
        (St.black = { primary: "#2C2E2F" }),
        St),
      Xt = ["logoColor"],
      Jt =
        (((Rt = {}).default = {
      ...
      qt = ["logoColor"],
      Qt =
        (((Pt = {}).default = { primary: "#0EE06E" }),
        (Pt.white = { primary: "#FFFFFF" }),
        (Pt.black = { primary: "#000000" }),
        Pt),
      $t = ["logoColor"],
      no =
        (((kt = {}).default = { primary: "#FFFFFF", secondary: "#FFFFFF" }),
        (kt.white = { primary: "#FFFFFF", secondary: "#FFFFFF" }),
        (kt.black = { primary: "#E39E39", secondary: "#D8232A" }),
        kt),
      eo = ["logoColor"],
      to =
        (((Zt = {}).default = { primary: "#FFFFFF" }),
        (Zt.white = { primary: "#FFFFFF" }),
        (Zt.black = { primary: "#000000" }),
        Zt),
      oo = ["logoColor"],
      ro =
        (((_t = {}).default = {
      ...
      lo = ["logoColor"],
      ao =
        (((Ut = {}).default = { primary: "#FFFFFF", secondary: "#FFFFFF" }),
        (Ut.white = { primary: "#FFFFFF", secondary: "#FFFFFF" }),
        (Ut.black = { primary: "#1866AB", secondary: "#373535" }),
        Ut),
      io = ["logoColor"],
      uo =
        (((It = {}).default = { primary: "#FFFFFF" }),
        (It.white = { primary: "#FFFFFF" }),
        (It.black = { primary: "#2C2E2F" }),
        It),
      co = ["logoColor"],
      Co =
        (((Dt = {}).default = {
        ...
        ar: {
          Checkout: function (n) {
            ...
            return f(
              s,
              null,
              f(ho, { animate: !0, optional: !0 }, "السداد بواسطة", " "),
              e
            );
          },
          Subscribe: function (n) {
            return f(
              ...
              null,
              n.logo,
              f(ho, { animate: !0, optional: !0 }, " ", "اشتراك")
            );
          },
          SaferTag: function () {
            return f(
          ...
          Pay: function (n) {
            ...
            return f(
              s,
              null,
              f(ho, { animate: !0, optional: !0 }, "دفع بواسطة", " "),
              e
            );
          },
          BuyNow: function (n) {
            return f(
              ...
              null,
              n.logo,
              f(ho, { animate: !0, optional: !0 }, " ", "شراء الآن")
            );
          },
          Donate: function (n) {
            return f(
              ...
              null,
              n.logo,
              f(ho, { animate: !0, optional: !0 }, " ", "تبرع", " ")
            );
          },
        },
        bg: {
          Checkout: function (n) {
            return f(
              ...
              null,
              n.logo,
              f(ho, { animate: !0, optional: !0 }, " ", "Финализиране")
            );
          },
          Subscribe: function (n) {
            return f(
              ...
              null,
              n.logo,
              f(ho, { animate: !0, optional: !0 }, " ", "Абониране")
            );
          },
          SaferTag: function () {
            return f(
          ...
          Pay: function (n) {
            ...
            return f(
              s,
              null,
              f(ho, { animate: !0, optional: !0 }, "Плащане с", " "),
              e
            );
          },
          BuyNow: function (n) {
            return f(
              ...
              null,
              n.logo,
              f(ho, { animate: !0, optional: !0 }, " ", "Купете сега")
            );
          },
          Donate: function (n) {
            return f(
              ...
              null,
              n.logo,
              f(ho, { animate: !0, optional: !0 }, " ", "Дарение")
            );
          },
        },
        cs: {
          Checkout: function (n) {
            ...
            return f(
              s,
              null,
              f(ho, { animate: !0, optional: !0 }, "Zaplatit přes", " "),
              e
            );
          },
          Subscribe: function (n) {
            return f(
              ...
              null,
              n.logo,
              f(ho, { animate: !0, optional: !0 }, " ", "Předplatit")
            );
          },
          SaferTag: function () {
            return f(
          ...
          BuyNow: function (n) {
            ...
            return f(
              s,
              null,
              f(ho, { animate: !0, optional: !0 }, "Koupit ihned přes", " "),
              e
            );
          },
          Donate: function (n) {
            return f(
              ...
              null,
              n.logo,
              f(ho, { animate: !0, optional: !0 }, " ", "Přispět")
            );
          },
        },
        da: {
          Checkout: function (n) {
            return f(
              ...
              null,
              n.logo,
              f(ho, { animate: !0, optional: !0 }, " ", "Betal")
            );
          },
          Subscribe: function (n) {
            return f(
              ...
              null,
              n.logo,
              f(ho, { animate: !0, optional: !0 }, " ", "Abonner")
            );
          },
          SaferTag: function () {
            return f(
          ...
          Pay: function (n) {
            ...
            return f(
              s,
              null,
              f(ho, { animate: !0, optional: !0 }, "Betal med", " "),
              e
            );
          },
          BuyNow: function (n) {
            return f(
              ...
              null,
              n.logo,
              f(ho, { animate: !0, optional: !0 }, " ", "Køb nu")
            );
          },
          Donate: function (n) {
            return f(
              ...
              null,
              n.logo,
              f(ho, { animate: !0, optional: !0 }, " ", "Doner")
            );
          },
        },
        de: {
          Checkout: function (n) {
            ...
            return f(
              s,
              null,
              f(ho, { animate: !0, optional: !0 }, "Direkt zu", " "),
              e
            );
          },
          Subscribe: function (n) {
            return f(
              ...
              null,
              n.logo,
              f(ho, { animate: !0, optional: !0 }, " ", "Abonnieren")
            );
          },
          SaferTag: function () {
            return f(
          ...
          Pay: function (n) {
            ...
            return f(
              s,
              null,
              f(ho, { animate: !0, optional: !0 }, "Mit", " "),
              e,
              f(ho, { animate: !0, optional: !0 }, " ", "zahlen")
            );
          },
          BuyNow: function (n) {
            return f(
              ...
              null,
              n.logo,
              f(ho, { animate: !0, optional: !0 }, " ", "Jetzt kaufen")
            );
          },
          Donate: function (n) {
            return f(
              ...
              null,
              n.logo,
              f(ho, { animate: !0, optional: !0 }, " ", "Spenden")
            );
          },
        },
        el: {
          ...
          Subscribe: function (n) {
            return f(
              ...
              null,
              n.logo,
              f(ho, { animate: !0, optional: !0 }, " ", "Εγγραφή")
            );
          },
          SaferTag: function () {
            return f(
          ...
          Pay: function (n) {
            ...
            return f(
              s,
              null,
              f(ho, { animate: !0, optional: !0 }, "Πληρωμή μέσω", " "),
              e
            );
          },
          BuyNow: function (n) {
            return f(
              ...
              null,
              n.logo,
              f(ho, { animate: !0, optional: !0 }, " ", "Αγορά τώρα")
            );
          },
          Donate: function (n) {
            return f(
              ...
              null,
              n.logo,
              f(ho, { animate: !0, optional: !0 }, " ", "Δωρεά")
            );
          },
        },
        en: {
          Checkout: function (n) {
            return f(
              ...
              null,
              n.logo,
              f(ho, { animate: !0, optional: !0 }, " ", "Checkout")
            );
          },
          Subscribe: function (n) {
            return f(
              ...
              null,
              n.logo,
              f(ho, { animate: !0, optional: !0 }, " ", "Subscribe")
            );
          },
          SaferTag: function () {
            return f(
          ...
          Pay: function (n) {
            ...
            return f(
              s,
              null,
              f(ho, { animate: !0, optional: !0 }, "Pay with", " "),
              e
            );
          },
          ...
          DualTag: function () {
            return f(ho, { animate: !0, optional: !0 }, "Two easy ways to pay");
          },
          BuyNow: function (n) {
            return f(
              s,
              null,
              n.logo,
              f(ho, { animate: !0, optional: !0 }, " ", "Buy Now")
            );
          },
          Donate: function (n) {
            return f(
              ...
              null,
              n.logo,
              f(ho, { animate: !0, optional: !0 }, " ", "Donate")
            );
          },
        },
        es: {
          Checkout: function (n) {
            return f(
              ...
              null,
              n.logo,
              f(ho, { animate: !0, optional: !0 }, " ", "Pagar")
            );
          },
          Subscribe: function (n) {
            return f(
              ...
              null,
              n.logo,
              f(ho, { animate: !0, optional: !0 }, " ", "Suscribirse")
            );
          },
          SaferTag: function () {
            return f(
          ...
          Pay: function (n) {
            ...
            return f(
              s,
              null,
              f(ho, { animate: !0, optional: !0 }, "Pagar con", " "),
              e
            );
          },
          Installment: function (n) {
          ...
          BuyNow: function (n) {
            return f(
              ...
              null,
              n.logo,
              f(ho, { animate: !0, optional: !0 }, " ", "Comprar ahora")
            );
          },
          Donate: function (n) {
            return f(
              ...
              null,
              n.logo,
              f(ho, { animate: !0, optional: !0 }, " ", "Donar")
            );
          },
        },
        et: {
          Checkout: function (n) {
            return f(
              ...
              null,
              n.logo,
              f(ho, { animate: !0, optional: !0 }, " ", "Kassa")
            );
          },
          Subscribe: function (n) {
            return f(
              ...
              null,
              n.logo,
              f(ho, { animate: !0, optional: !0 }, " ", "Tellige")
            );
          },
          SaferTag: function () {
            return f(
          ...
          Pay: function (n) {
            ...
            return f(
              s,
              null,
              f(ho, { animate: !0, optional: !0 }, "Makske", " "),
              e
            );
          },
          BuyNow: function (n) {
            return f(
              ...
              null,
              n.logo,
              f(ho, { animate: !0, optional: !0 }, " ", "Osta kohe")
            );
          },
          Donate: function (n) {
            return f(
              ...
              null,
              n.logo,
              f(ho, { animate: !0, optional: !0 }, " ", "Annetage")
            );
          },
        },
        fi: {
          Checkout: function (n) {
            return f(
              ...
              null,
              n.logo,
              f(ho, { animate: !0, optional: !0 }, "-maksu")
            );
          },
          Subscribe: function (n) {
            return f(
              ...
              null,
              n.logo,
              f(ho, { animate: !0, optional: !0 }, " ", "Tilaa")
            );
          },
          SaferTag: function () {
            return f(
          ...
          BuyNow: function (n) {
            return f(
              ...
              null,
              n.logo,
              f(ho, { animate: !0, optional: !0 }, " ", "Osta nyt")
            );
          },
          Donate: function (n) {
            return f(
              ...
              null,
              n.logo,
              f(ho, { animate: !0, optional: !0 }, " ", "Lahjoita")
            );
          },
        },
        fr: {
          Checkout: function (n) {
            return f(
              ...
              null,
              n.logo,
              f(ho, { animate: !0, optional: !0 }, " ", "Payer")
            );
          },
          Subscribe: function (n) {
            return f(
              ...
              null,
              n.logo,
              f(ho, { animate: !0, optional: !0 }, " ", "S'abonner")
            );
          },
          SaferTag: function () {
            return f(
          ...
          Pay: function (n) {
            ...
            return f(
              s,
              null,
              f(ho, { animate: !0, optional: !0 }, "Payer avec", " "),
              e
            );
          },
          BuyNow: function (n) {
            return f(
              ...
              null,
              n.logo,
              f(ho, { animate: !0, optional: !0 }, " ", "Acheter")
            );
          },
          Donate: function (n) {
            return f(
              ...
              null,
              n.logo,
              f(ho, { animate: !0, optional: !0 }, " ", "Faire un don")
            );
          },
        },
        he: {
          ...
          Subscribe: function (n) {
            return f(
              ...
              null,
              n.logo,
              f(ho, { animate: !0, optional: !0 }, " ", "הצטרפות כמנוי")
            );
          },
          SaferTag: function () {
            return f(
          ...
          Pay: function (n) {
            ...
            return f(
              s,
              null,
              f(ho, { animate: !0, optional: !0 }, "שלם באמצעות", " "),
              e,
              f(ho, { animate: !0, optional: !0 }, "‏")
            );
          },
          BuyNow: function (n) {
            return f(
              ...
              null,
              n.logo,
              f(ho, { animate: !0, optional: !0 }, " ", "קנה עכשיו")
            );
          },
          Donate: function (n) {
            return f(
              ...
              null,
              n.logo,
              f(ho, { animate: !0, optional: !0 }, " ", "שליחת תרומה")
            );
          },
        },
        hu: {
          Checkout: function (n) {
            return f(
              ...
              null,
              n.logo,
              f(ho, { animate: !0, optional: !0 }, "-fizetés")
            );
          },
          Subscribe: function (n) {
            return f(
              ...
              null,
              n.logo,
              f(ho, { animate: !0, optional: !0 }, " ", "Feliratkozás")
            );
          },
          SaferTag: function () {
            return f(
          ...
          BuyNow: function (n) {
            return f(
              ...
              null,
              n.logo,
              f(ho, { animate: !0, optional: !0 }, " ", "Vásárlás")
            );
          },
          Donate: function (n) {
            return f(
              ...
              null,
              n.logo,
              f(ho, { animate: !0, optional: !0 }, " ", "Adományozás")
            );
          },
        },
        id: {
          ...
          Subscribe: function (n) {
            return f(
              ...
              null,
              n.logo,
              f(ho, { animate: !0, optional: !0 }, " ", "Berlangganan")
            );
          },
          SaferTag: function () {
            return f(
          ...
          Pay: function (n) {
            ...
            return f(
              s,
              null,
              f(ho, { animate: !0, optional: !0 }, "Bayar dengan", " "),
              e
            );
          },
          BuyNow: function (n) {
            return f(
              ...
              null,
              n.logo,
              f(ho, { animate: !0, optional: !0 }, " ", "Beli Sekarang")
            );
          },
          Donate: function (n) {
            return f(
              ...
              null,
              n.logo,
              f(ho, { animate: !0, optional: !0 }, " ", "Donasikan")
            );
          },
        },
        it: {
          Checkout: function (n) {
            return f(
              ...
              null,
              n.logo,
              f(ho, { animate: !0, optional: !0 }, " ", "Paga adesso")
            );
          },
          Subscribe: function (n) {
            return f(
              ...
              null,
              n.logo,
              f(ho, { animate: !0, optional: !0 }, " ", "Abbonati")
            );
          },
          SaferTag: function () {
            return f(
          ...
          Pay: function (n) {
            ...
            return f(
              s,
              null,
              f(ho, { animate: !0, optional: !0 }, "Paga con", " "),
              e
            );
          },
          BuyNow: function (n) {
          ...
          Donate: function (n) {
            return f(
              ...
              null,
              n.logo,
              f(ho, { animate: !0, optional: !0 }, " ", "Donazione")
            );
          },
        },
        ja: {
          Checkout: function (n) {
            return f(
              ...
              null,
              n.logo,
              f(ho, { animate: !0, optional: !0 }, "で支払う")
            );
          },
          Subscribe: function (n) {
            return f(
          ...
          Donate: function (n) {
            return f(
              ...
              null,
              n.logo,
              f(ho, { animate: !0, optional: !0 }, " ", "寄付する")
            );
          },
        },
        ko: {
          Checkout: function (n) {
            return f(
              ...
              null,
              n.logo,
              f(ho, { animate: !0, optional: !0 }, " ", "체크 아웃")
            );
          },
          Subscribe: function (n) {
            return f(
              ...
              null,
              n.logo,
              f(ho, { animate: !0, optional: !0 }, " ", "정기결제")
            );
          },
          SaferTag: function () {
            return f(
          ...
          Pay: function (n) {
            return f(
              ...
              null,
              n.logo,
              f(ho, { animate: !0, optional: !0 }, "로 지불하기")
            );
          },
          BuyNow: function (n) {
            return f(
              ...
              null,
              n.logo,
              f(ho, { animate: !0, optional: !0 }, " ", "바로 구매")
            );
          },
          Donate: function (n) {
            return f(
        ...
        lt: {
          ...
          Subscribe: function (n) {
            return f(
              ...
              null,
              n.logo,
              f(ho, { animate: !0, optional: !0 }, " ", "prenumeruoti")
            );
          },
          SaferTag: function () {
            return f(
          ...
          Pay: function (n) {
            ...
            return f(
              s,
              null,
              f(ho, { animate: !0, optional: !0 }, "Mokėti naudojant", " "),
              e
            );
          },
          BuyNow: function (n) {
            return f(
              ...
              null,
              n.logo,
              f(ho, { animate: !0, optional: !0 }, " ", "pirkti dabar")
            );
          },
          Donate: function (n) {
            return f(
              ...
              null,
              n.logo,
              f(ho, { animate: !0, optional: !0 }, " ", "Paaukoti")
            );
          },
        },
        lv: {
          ...
          Subscribe: function (n) {
            return f(
              ...
              null,
              n.logo,
              f(ho, { animate: !0, optional: !0 }, " ", "abonēt")
            );
          },
          SaferTag: function () {
            return f(
          ...
          Pay: function (n) {
            ...
            return f(
              s,
              null,
              f(ho, { animate: !0, optional: !0 }, "Maksāt ar", " "),
              e
            );
          },
          BuyNow: function (n) {
            return f(
              ...
              null,
              n.logo,
              f(ho, { animate: !0, optional: !0 }, " ", "pirkt tūlīt", " ")
            );
          },
          Donate: function (n) {
            return f(
              ...
              null,
              n.logo,
              f(ho, { animate: !0, optional: !0 }, " ", "Ziedot")
            );
          },
        },
        ms: {
          Checkout: function (n) {
            ...
            return f(
              s,
              null,
              f(ho, { animate: !0, optional: !0 }, "Daftar keluar", " "),
              e
            );
          },
          Subscribe: function (n) {
            ...
            return f(
              s,
              null,
              f(ho, { animate: !0, optional: !0 }, "Langgan", " "),
              e
            );
          },
          SaferTag: function () {
          ...
          Donate: function (n) {
            ...
            return f(
              s,
              null,
              f(ho, { animate: !0, optional: !0 }, "Derma", " "),
              e
            );
          },
        },
        nl: {
          Checkout: function (n) {
            return f(
              ...
              null,
              n.logo,
              f(ho, { animate: !0, optional: !0 }, " ", "Betalen")
            );
          },
          Subscribe: function (n) {
            return f(
              ...
              null,
              n.logo,
              f(ho, { animate: !0, optional: !0 }, " ", "Abonneren")
            );
          },
          SaferTag: function () {
            return f(
          ...
          Pay: function (n) {
            ...
            return f(
              s,
              null,
              f(ho, { animate: !0, optional: !0 }, "Betalen met", " "),
              e
            );
          },
          BuyNow: function (n) {
            return f(
              ...
              null,
              n.logo,
              f(ho, { animate: !0, optional: !0 }, " ", "Nu kopen")
            );
          },
          Donate: function (n) {
            return f(
              ...
              null,
              n.logo,
              f(ho, { animate: !0, optional: !0 }, " ", "Doneren")
            );
          },
        },
        no: {
          ...
          BuyNow: function (n) {
            return f(
              ...
              null,
              n.logo,
              f(ho, { animate: !0, optional: !0 }, " ", "Kjøp nå")
            );
          },
          Donate: function (n) {
            return f(
        ...
        pl: {
          Checkout: function (n) {
            return f(
              ...
              null,
              n.logo,
              f(ho, { animate: !0, optional: !0 }, " ", "Do kasy")
            );
          },
          Subscribe: function (n) {
            return f(
              ...
              null,
              n.logo,
              f(ho, { animate: !0, optional: !0 }, " ", "Subskrybuj")
            );
          },
          SaferTag: function () {
            return f(
          ...
          Pay: function (n) {
            ...
            return f(
              s,
              null,
              f(ho, { animate: !0, optional: !0 }, "Zapłać z", " "),
              e
            );
          },
          BuyNow: function (n) {
            return f(
              ...
              null,
              n.logo,
              f(ho, { animate: !0, optional: !0 }, " ", "Kup teraz")
            );
          },
          Donate: function (n) {
            return f(
              ...
              null,
              n.logo,
              f(ho, { animate: !0, optional: !0 }, " ", "Przekaż darowiznę")
            );
          },
        },
        pt: {
          ...
          Subscribe: function (n) {
            return f(
              ...
              null,
              n.logo,
              f(ho, { animate: !0, optional: !0 }, " ", "Assinar")
            );
          },
          SaferTag: function () {
            return f(
          ...
          Pay: function (n) {
            ...
            return f(
              s,
              null,
              f(ho, { animate: !0, optional: !0 }, "Pague com", " "),
              e
            );
          },
          Installment: function (n) {
          ...
          BuyNow: function (n) {
            return f(
              ...
              null,
              n.logo,
              f(ho, { animate: !0, optional: !0 }, " ", "Comprar agora")
            );
          },
          Donate: function (n) {
            return f(
              ...
              null,
              n.logo,
              f(ho, { animate: !0, optional: !0 }, " ", "Doar")
            );
          },
        },
        ro: {
          ...
          Subscribe: function (n) {
            return f(
              ...
              null,
              n.logo,
              f(ho, { animate: !0, optional: !0 }, " ", "Abonează-te")
            );
          },
          SaferTag: function () {
            return f(
          ...
          Pay: function (n) {
            ...
            return f(
              s,
              null,
              f(ho, { animate: !0, optional: !0 }, "Plătește cu", " "),
              e
            );
          },
          BuyNow: function (n) {
            return f(
              ...
              null,
              n.logo,
              f(ho, { animate: !0, optional: !0 }, " ", "Cumpără acum")
            );
          },
          Donate: function (n) {
            return f(
              ...
              null,
              n.logo,
              f(ho, { animate: !0, optional: !0 }, " ", "Donează")
            );
          },
        },
        ru: {
          Checkout: function (n) {
            return f(
              ...
              null,
              n.logo,
              f(ho, { animate: !0, optional: !0 }, " ", "Оформить покупку")
            );
          },
          Subscribe: function (n) {
            return f(
              ...
              null,
              n.logo,
              f(ho, { animate: !0, optional: !0 }, " ", "Подписаться")
            );
          },
          SaferTag: function () {
            return f(
          ...
          Pay: function (n) {
            ...
            return f(
              s,
              null,
              f(ho, { animate: !0, optional: !0 }, "Оплатить через", " "),
              e
            );
          },
          BuyNow: function (n) {
            return f(
              ...
              null,
              n.logo,
              f(ho, { animate: !0, optional: !0 }, " ", "Купить сейчас")
            );
          },
          Donate: function (n) {
            return f(
              ...
              null,
              n.logo,
              f(ho, { animate: !0, optional: !0 }, " ", "Сделать пожертвование")
            );
          },
        },
        si: {
          Checkout: function (n) {
            return f(
              ...
              null,
              n.logo,
              f(ho, { animate: !0, optional: !0 }, " ", "ගෙවා පිටවීම")
            );
          },
          Subscribe: function (n) {
            return f(
              ...
              null,
              n.logo,
              f(ho, { animate: !0, optional: !0 }, " ", "දායක වන්න")
            );
          },
          SaferTag: function () {
            return f(
          ...
          Pay: function (n) {
            return f(
              ...
              null,
              n.logo,
              f(ho, { animate: !0, optional: !0 }, " ", "සමග ගෙවන්න")
            );
          },
          BuyNow: function (n) {
            return f(
              ...
              null,
              n.logo,
              f(ho, { animate: !0, optional: !0 }, " ", "දැන් මිලදී ගන්න")
            );
          },
          Donate: function (n) {
            return f(
              ...
              null,
              n.logo,
              f(ho, { animate: !0, optional: !0 }, " ", "පරිත්‍යාග කරන්න")
            );
          },
        },
        sk: {
          Checkout: function (n) {
            ...
            return f(
              s,
              null,
              f(ho, { animate: !0, optional: !0 }, "Zaplatiť cez", " "),
              e
            );
          },
          Subscribe: function (n) {
            return f(
              ...
              null,
              n.logo,
              f(ho, { animate: !0, optional: !0 }, " ", "Predplatiť")
            );
          },
          SaferTag: function () {
            return f(
          ...
          BuyNow: function (n) {
            return f(
              ...
              null,
              n.logo,
              f(ho, { animate: !0, optional: !0 }, " ", "Kúpiť")
            );
          },
          Donate: function (n) {
            return f(
              ...
              null,
              n.logo,
              f(ho, { animate: !0, optional: !0 }, " ", "Prispieť")
            );
          },
        },
        sl: {
          Checkout: function (n) {
            return f(
              ...
              null,
              n.logo,
              f(ho, { animate: !0, optional: !0 }, " ", "Blagajna")
            );
          },
          Subscribe: function (n) {
            return f(
              ...
              null,
              n.logo,
              f(ho, { animate: !0, optional: !0 }, " ", "Naroči se")
            );
          },
          SaferTag: function () {
            return f(
          ...
          Pay: function (n) {
            ...
            return f(
              s,
              null,
              f(ho, { animate: !0, optional: !0 }, "Plačaj z", " "),
              e
            );
          },
          BuyNow: function (n) {
            return f(
              ...
              null,
              n.logo,
              f(ho, { animate: !0, optional: !0 }, " ", "Kupi zdaj")
            );
          },
          Donate: function (n) {
            return f(
              ...
              null,
              n.logo,
              f(ho, { animate: !0, optional: !0 }, " ", "Donirajte")
            );
          },
        },
        sq: {
          Checkout: function (n) {
            ...
            return f(
              s,
              null,
              f(ho, { animate: !0, optional: !0 }, "Arka e", " "),
              e
            );
          },
          Subscribe: function (n) {
            ...
            return f(
              s,
              null,
              f(ho, { animate: !0, optional: !0 }, "Abonohu në", " "),
              e
            );
          },
          SaferTag: function () {
          ...
          Pay: function (n) {
            ...
            return f(
              s,
              null,
              f(ho, { animate: !0, optional: !0 }, "Paguaj me", " "),
              e
            );
          },
          BuyNow: function (n) {
            ...
            return f(
              s,
              null,
              f(ho, { animate: !0, optional: !0 }, "Bli tani me", " "),
              e
            );
          },
          Donate: function (n) {
            ...
            return f(
              s,
              null,
              f(ho, { animate: !0, optional: !0 }, "Dhuro", " "),
              e
            );
          },
        },
        sv: {
          Checkout: function (n) {
            return f(
              ...
              null,
              n.logo,
              f(ho, { animate: !0, optional: !0 }, " ", "Betala")
            );
          },
          Subscribe: function (n) {
            return f(
              ...
              null,
              n.logo,
              f(ho, { animate: !0, optional: !0 }, " ", "Prenumerera")
            );
          },
          SaferTag: function () {
            return f(
          ...
          Pay: function (n) {
            ...
            return f(
              s,
              null,
              f(ho, { animate: !0, optional: !0 }, "Betala med", " "),
              e
            );
          },
          BuyNow: function (n) {
            return f(
              ...
              null,
              n.logo,
              f(ho, { animate: !0, optional: !0 }, " ", "Köp nu")
            );
          },
          Donate: function (n) {
            return f(
              ...
              null,
              n.logo,
              f(ho, { animate: !0, optional: !0 }, " ", "Donera")
            );
          },
        },
        th: {
          Checkout: function (n) {
            return f(
              ...
              null,
              n.logo,
              f(ho, { animate: !0, optional: !0 }, " ", "ชำระเงิน")
            );
          },
          Subscribe: function (n) {
            return f(
              ...
              null,
              n.logo,
              f(ho, { animate: !0, optional: !0 }, " ", "ชำระค่าสมาชิก")
            );
          },
          SaferTag: function () {
            return f(
          ...
          Pay: function (n) {
            ...
            return f(
              s,
              null,
              f(ho, { animate: !0, optional: !0 }, "ชำระเงินด้วย", " "),
              e
            );
          },
          BuyNow: function (n) {
            return f(
              ...
              null,
              n.logo,
              f(ho, { animate: !0, optional: !0 }, " ", "ซื้อทันที")
            );
          },
          Donate: function (n) {
            return f(
              ...
              null,
              n.logo,
              f(ho, { animate: !0, optional: !0 }, " ", "บริจาค")
            );
          },
        },
        tl: {
          ...
          Subscribe: function (n) {
            return f(
              ...
              null,
              n.logo,
              f(ho, { animate: !0, optional: !0 }, " ", "Mag-subscribe")
            );
          },
          SaferTag: function () {
            return f(
          ...
          Pay: function (n) {
            ...
            return f(
              s,
              null,
              f(ho, { animate: !0, optional: !0 }, "Magbayad gamit ang", " "),
              e
            );
          },
          BuyNow: function (n) {
            return f(
              ...
              null,
              n.logo,
              f(ho, { animate: !0, optional: !0 }, " ", "Bumili Ngayon")
            );
          },
          Donate: function (n) {
            return f(
              ...
              null,
              n.logo,
              f(ho, { animate: !0, optional: !0 }, " ", "Mag-donate")
            );
          },
        },
        tr: {
          Checkout: function (n) {
            return f(
              ...
              null,
              n.logo,
              f(ho, { animate: !0, optional: !0 }, " ", "ile Satın Alın")
            );
          },
          SaferTag: function () {
            return f(
          ...
          Pay: function (n) {
            return f(
              ...
              null,
              n.logo,
              f(ho, { animate: !0, optional: !0 }, " ", "ile Öde")
            );
          },
          BuyNow: function (n) {
            return f(
              ...
              null,
              n.logo,
              f(ho, { animate: !0, optional: !0 }, " ", "Hemen Satın Alın")
            );
          },
        },
        vi: {
          Checkout: function (n) {
            return f(
              ...
              null,
              n.logo,
              f(ho, { animate: !0, optional: !0 }, " ", "Thanh toán")
            );
          },
          Subscribe: function (n) {
            return f(
              ...
              null,
              n.logo,
              f(ho, { animate: !0, optional: !0 }, " ", "Đăng ký")
            );
          },
          SaferTag: function () {
            return f(
          ...
          Pay: function (n) {
            ...
            return f(
              s,
              null,
              f(ho, { animate: !0, optional: !0 }, "Thanh toán bằng", " "),
              e
            );
          },
          BuyNow: function (n) {
            return f(
              ...
              null,
              n.logo,
              f(ho, { animate: !0, optional: !0 }, " ", "Mua ngay")
            );
          },
          Donate: function (n) {
            return f(
              ...
              null,
              n.logo,
              f(ho, { animate: !0, optional: !0 }, " ", "Quyên góp")
            );
          },
        },
        zh: {
          ...
          Pay: function (n) {
            ...
            return f(
              s,
              null,
              f(ho, { animate: !0, optional: !0 }, "用"),
              e,
              f(ho, { animate: !0, optional: !0 }, "付款")
            );
          },
          Donate: function (n) {
            return f(
          ...
          BuyNow: function (n) {
            return f(
              ...
              null,
              n.logo,
              f(ho, { animate: !0, optional: !0 }, " ", "立即购买")
            );
          },
        },
        zh_Hant: {
          ...
          Subscribe: function (n) {
            return f(
              ...
              null,
              n.logo,
              f(ho, { animate: !0, optional: !0 }, " ", "訂閱")
            );
          },
          SaferTag: function () {
            return f(ho, { animate: !0, optional: !0 }, "更安全方便的付款方式");
          },
          Pay: function (n) {
            var e = n.logo;
            return f(
    ...
    var No = "\n    max-width: 0%;\n    opacity: 0;\n    overflow: hidden;\n",
      ...
      Po = t.n(Ro);
    function ko(n) {
      return f(Lt, { logoColor: n.logoColor, "data-v-fd53f700": "" });
    }
    function Zo(n) {
      ...
      if (!n.tagline && n.label) {
        ...
        if (t)
          return f(
            ...
            o && f(Ho, { url: o, nonce: e, "data-v-fd53f700": "" }),
            (function (n) {
              var e = !n.tagline && Zo(n),
    ...
    function Uo(n) {
      return f(
        s,
        { "data-v-fd53f700": "" },
        f(Eo, y({}, n, { "data-v-fd53f700": "" })),
        f(_o, y({}, n, { "data-v-fd53f700": "" }))
      );
    }
    function Io(n) {
      var e = n.instrument,
          ...
          f(
            ...
            e && t
              ? o
                ? t.payNow
                : t.payWith
              : f(Lo, { chars: 7, color: r, "data-v-fd53f700": "" })
          ),
          f(go, { "data-v-fd53f700": "" })
        ),
        f(
          ...
          e && l
            ...
            : f(
                ho,
                { "data-v-fd53f700": "" },
                f(Lo, { chars: 4, color: r, "data-v-fd53f700": "" })
              )
        ),
        f(
          "div",
          ...
          f(
            ho,
            { "data-v-fd53f700": "" },
            e && a ? a : f(Lo, { chars: 6, color: r, "data-v-fd53f700": "" })
          )
        )
      );
    }
              ...
              f(
                ...
                t && r
                  ...
                  : f(
                      ho,
                      { "data-v-fd53f700": "" },
                      f(Lo, { chars: 4, color: o, "data-v-fd53f700": "" })
                    )
              ),
              f(
                "div",
                ...
                f(
                  ...
                  t && l
                    ? l
                    : f(Lo, { chars: 6, color: o, "data-v-fd53f700": "" })
                )
              )
            )
      );
    ...
    function zo(n) {
        ...
        return (function (n) {
          ...
          return (
            o.logoUrl
              ...
              : "card" === o.type
              ? (e = f(Ye, { logoColor: t, "data-v-fd53f700": "" }))
              : "bank" === o.type
              ? (e = f(Se, { logoColor: t, "data-v-fd53f700": "" }))
              : "credit" === o.type &&
                (e = f(Xe, { locale: r, logoColor: t, "data-v-fd53f700": "" })),
            f(
              O,
              { css: Po.a, "data-v-fd53f700": "" },
              f(
                "div",
                ...
                f(
                  ...
                  f(yt, { logoColor: t, "data-v-fd53f700": "" })
                ),
                o.oneClick &&
                  a &&
                  l &&
                  f(
                    ...
                    f(go, { "data-v-fd53f700": "" }),
                    f(ho, { "data-v-fd53f700": "" }, l.payNow)
                  ),
                f(
                  "div",
                  { class: "paypal-wordmark", "data-v-fd53f700": "" },
                  f(go, { "data-v-fd53f700": "" }),
                  f(Lt, { logoColor: t, "data-v-fd53f700": "" })
                ),
      ...
      if (
        ...
        var s = f(Ye, { logoColor: r, "data-v-fd53f700": "" }),
          p = f(Se, { logoColor: r, "data-v-fd53f700": "" });
        "card" === l.type && l.label
          ? ((e = l.logoUrl
              ? f("img", {
                  class: "card-art",
          ...
          ? ((e = l.logoUrl
            ...
            (t = l.label.replace("••••", "••")))
          : "credit" === l.type
          ? ((e = f(Je, { "data-v-fd53f700": "" })), (t = a && a.credit))
          : "balance" === l.type
          ? ((e = f(bt, { "data-v-fd53f700": "" })), (t = a && a.balance))
          : l.label && (t = l.label);
      }
          ...
          f(
            ...
            o
              ? f(
                  "div",
                  { class: "paypal-mark", "data-v-fd53f700": "" },
                  f(yt, { logoColor: r, "data-v-fd53f700": "" }),
                  f(go, { "data-v-fd53f700": "" })
                )
              : null,
            C
    ...
    function jo(n) {
      var e,
        t = y({}, (Ee(n), n)),
        o = t.instrument,
        r = f(Bt, { logoColor: t.logoColor, "data-v-f451091d": "" });
      return (
        o && o.label && (e = o.label),
        f(
          O,
          { css: Go.a, "data-v-f451091d": "" },
          f(
            "div",
            ...
            r &&
              f(
                ...
                r,
                f(go, { "data-v-f451091d": "" })
              ),
            e &&
              f(
                "div",
                { class: "label", "data-v-f451091d": "" },
                f(ho, { className: ["limit"], "data-v-f451091d": "" }, e)
              )
          )
        )
      );
        ...
        Label: function (n) {
          var e = n.logo,
            ...
            o = f(
              ...
              e,
              f(go, null),
              f(ho, { animate: !0, optional: !0 }, "Boleto Bancário")
            );
          return f(Eo, y({}, t, { logo: o }));
        },
      });
    }
    var pr,
              ...
              return (
                ...
                (n[M.VENMO] = (function () {
                  ...
                  return y({}, Ao, {
                    ...
                    Label: function (n) {
                      var e = y({}, (Ee(n), n));
                      return f(Eo, y({}, e, { "data-v-f451091d": "" }));
                    },
                  ...
                  return y({}, Ao, {
                    ...
                    Mark: function (n) {
                      ...
                      return (function (n) {
                        ...
                        return f(
                          O,
                          { css: Xo.a, "data-v-777fbc9f": "" },
                          f(Ae, y({}, e, { "data-v-777fbc9f": "" }))
                        );
                      })(y({}, e));
                    },
                    colors: ["black", "white"],
                ...
                (n[M.PAYLATER] = (function () {
                  ...
                  return y({}, Ao, {
                    ...
                    Logo: function (n) {
                      ...
                      return f(
                        O,
                        { css: qo.a, nonce: n.nonce, "data-v-b0257cc2": "" },
                        f(yt, {
                          logoColor: n.logoColor,
                          "data-v-b0257cc2": "",
                        }),
                        f(go, { "data-v-b0257cc2": "" }),
                        f(ho, { "data-v-b0257cc2": "" }, Qo(e) || "Pay Later")
                      );
                    },
                    ...
                    labelText: function (n) {
                      var e = n.fundingEligibility;
                      return (e && Qo(e)) || M.PAYPAL + " " + M.PAYLATER;
                    },
                  });
                })()),
                (n[M.CARD] = (function () {
                  ...
                  return y({}, Ao, {
                    ...
                    Logo: function (n) {
                      return f(Ye, { logoColor: n.logoColor });
                    },
                    Label: function (n) {
                      var e,
                        t = n.logo,
                  ...
                  Label: function (n) {
                    var e = n.logo,
                      ...
                      o = f(
                        ...
                        e,
                        f(go, null),
                        f(ho, { animate: !0, optional: !0 }, "iDEAL")
                      );
                    return f(Eo, y({}, t, { logo: o }));
                  },
                })),
                  ...
                  Label: function (n) {
                    var e = n.logo,
                      ...
                      o = f(
                        ...
                        e,
                        f(go, null),
                        f(ho, { animate: !0, optional: !0 }, "Bancontact")
                      );
                    return f(Eo, y({}, t, { logo: o }));
                  },
                })),
                  ...
                  Label: function (n) {
                    var e = n.logo,
                      ...
                      o = f(
                        ...
                        e,
                        f(go, null),
                        f(ho, { animate: !0, optional: !0 }, "giropay")
                      );
                    return f(Eo, y({}, t, { logo: o }));
                  },
                })),
                  ...
                  Label: function (n) {
                    var e = n.logo,
                      ...
                      o = f(
                        ...
                        e,
                        f(go, null),
                        f(ho, { animate: !0, optional: !0 }, "SOFORT")
                      );
                    return f(Eo, y({}, t, { logo: o }));
                  },
                })),
                  ...
                  Label: function (n) {
                    var e = n.logo,
                      ...
                      o = f(
                        ...
                        e,
                        f(go, null),
                        f(ho, { animate: !0, optional: !0 }, "MyBank")
                      );
                    return f(Eo, y({}, t, { logo: o }));
                  },
                })),
                  ...
                  Label: function (n) {
                    var e = n.logo,
                      ...
                      o = f(
                        ...
                        e,
                        f(go, null),
                        f(ho, { animate: !0, optional: !0 }, "Przelewy24")
                      );
                    return f(Eo, y({}, t, { logo: o }));
                  },
                })),
                  ...
                  Label: function (n) {
                    var e = n.logo,
                      ...
                      o = f(
                        ...
                        e,
                        f(go, null),
                        f(ho, { animate: !0, optional: !0 }, "PayU")
                      );
                    return f(Eo, y({}, t, { logo: o }));
                  },
                })),
                  ...
                  Label: function (n) {
                    var e = n.logo,
                      ...
                      o = f(
                        ...
                        e,
                        f(go, null),
                        f(ho, { animate: !0, optional: !0 }, "BLIK")
                      );
                    return f(Eo, y({}, t, { logo: o }));
                  },
                })),
                  ...
                  Label: function (n) {
                    var e = n.logo,
                      ...
                      o = f(
                        ...
                        e,
                        f(go, null),
                        f(ho, { animate: !0, optional: !0 }, "Trustly")
                      );
                    return f(Eo, y({}, t, { logo: o }));
                  },
                })),
                  ...
                  Label: function (n) {
                    var e = n.logo,
                      ...
                      o = f(
                        ...
                        e,
                        f(go, null),
                        f(ho, { animate: !0, optional: !0 }, "WeChat Pay")
                      );
                    return f(Eo, y({}, t, { logo: o }));
                  },
                })),
                  ...
                  Label: function (n) {
                    var e = n.logo,
                      ...
                      o = f(
                        ...
                        e,
                        f(go, null),
                        f(ho, { animate: !0, optional: !0 }, "OXXO")
                      );
                    return f(Eo, y({}, t, { logo: o }));
                  },
                })),
                (n[M.BOLETO] = sr()),
                (n[M.BOLETOBANCARIO] = sr()),
                (n[M.MERCADOPAGO] = y({}, xo, {
                  shippingChange: !1,
                  layouts: [kn.VERTICAL],
                  Logo: function (n) {
                    return (function (n) {
                  ...
                  Label: function (n) {
                    var e = n.logo,
                      ...
                      o = f(
                        ...
                        e,
                        f(go, null),
                        f(ho, { animate: !0, optional: !0 }, "Mercado Pago")
                      );
                    return f(Eo, y({}, t, { logo: o }));
                  },
                })),
                  ...
                  Label: function (n) {
                    var e = n.logo,
                      ...
                      o = f(
                        ...
                        e,
                        f(go, null),
                        f(ho, { animate: !0, optional: !0 }, "Multibanco")
                      );
                    return f(Eo, y({}, t, { logo: o }));
                  },
                })),
                  ...
                  Label: function (n) {
                    var e = n.logo,
                      ...
                      o = f(
                        ...
                        e,
                        f(go, null),
                        f(ho, { animate: !0, optional: !0 }, "Satispay")
                      );
                    return f(Eo, y({}, t, { logo: o }));
                  },
                })),
                  ...
                  Label: function (n) {
                    var e = n.logo,
                      ...
                      o = f(
                        ...
                        e,
                        f(go, null),
                        f(ho, { animate: !0, optional: !0 }, "Paidy")
                      );
                    return f(Eo, y({}, t, { logo: o }));
                  },
                })),
    ...
    ((pr = {})[kn.HORIZONTAL] = "small"),
      (pr[kn.VERTICAL] = "medium"),
      ((hr = {})[kn.HORIZONTAL] = "huge"),
      (hr[kn.VERTICAL] = "huge");
    var Tr =
      (((gr = {}).tiny = {
        defaultWidth: 75,
    ...
    function Er(n, e, t) {
      ...
      return (
        ...
        o || t === Un.TOP || (e === kn.VERTICAL && !t) ? Un.TOP : Un.BOTTOM
      );
    }
    var Ar = {
    ...
    function Fr(n) {
      ...
      var e = Boolean(
        ...
        u = void 0 === i ? [] : i,
        c = n.locale,
        d = void 0 === c ? Ar.LOCALE : c,
        C = n.env,
        f = void 0 === C ? Ar.ENV : C,
        s = n.platform,
        p = void 0 === s ? Ar.PLATFORM : s,
        h = n.commit,
        g = void 0 === h ? Ar.COMMIT : h,
      ...
      return {
        ...
        style: (a = (function (n, e) {
          ...
          if (void 0 !== s) {
            ...
            var y = [Tr.small.minHeight, Tr.huge.maxHeight],
              b = y[0],
              w = y[1];
            if (!0 === v)
              throw new TypeError(
        ...
        message: (en = en
          ? (function (n, e, t) {
              var o = n.color,
                r = void 0 === o ? _n.BLACK : o,
                l = n.position,
                a = n.align,
                i = void 0 === a ? In.CENTER : a,
                u = n.offer,
                c = n.amount;
              if (void 0 !== c) {
                if (
              ...
              if (void 0 !== r && !mn(_n).includes(r))
                throw new Error("Invalid color: " + r);
              if (void 0 !== l && !mn(Un).includes(l))
                throw new Error("Invalid position: " + l);
              if (void 0 !== i && !mn(In).includes(i))
    ...
    function zr(n) {
      ...
      !_ ||
        ...
        (K = !0));
      var X = K && C && I({ instrument: C, userIDToken: T }),
        J = Or(A) ? zn.BORDER_RADIUS : zn.SHAPE + "-" + E;
      return f(
        "div",
        {
          class: [
        ...
        X ? f(Dr, { textColor: k, content: r }) : null
      );
    }
    function Wr(n) {
          ...
          u
            ? f(
                ...
                u.tracking &&
                  ...
                  f(Ho, { url: u.tracking.impression, nonce: r })
              )
    ...
    var Gr,
      jr = {
        ...
        el: {
          PoweredBy: function (n) {
            ...
            return f(
              s,
              null,
              f(ho, null, "Με την υποστήριξη του "),
              f(vt, { logoColor: e })
            );
          },
        },
        ...
        ko: {
          PoweredBy: function (n) {
            var e = n.logoColor;
            return f(s, null, f(ho, null, "제공: "), f(vt, { logoColor: e }));
          },
        },
        lt: {
          PoweredBy: function (n) {
            var e = n.logoColor;
            return f(s, null, f(ho, null, "Sukurta "), f(vt, { logoColor: e }));
          },
        },
        lv: {
          PoweredBy: function (n) {
        ...
        nl: {
          PoweredBy: function (n) {
            ...
            return f(
              s,
              null,
              f(ho, null, "Mogelijk gemaakt door "),
              f(vt, { logoColor: e })
            );
          },
        },
      ...
      Kr =
        ...
        " > .paypal-logo {\n        display: inline-block;\n        vertical-align: middle;\n        height: 16px;\n        line-height: 16px;\n        font-size: 11px;\n    }\n";
    function Xr(n) {
      var e = jr[n.locale.lang].PoweredBy;
      return f(
        "div",
        { class: zn.POWERED_BY },
        f("style", { nonce: n.nonce, innerHTML: Kr }),
        f(e, { logoColor: "blue" })
      );
    }
    function Jr(n) {
    ...
    function nl(n) {
      ...
      var R = V.some(function (n) {
        ...
        P = (function (n) {
          for (
            ...
            var i = o[a],
              u = qr({ wallet: e, fundingSource: i, hasShippingCallback: r });
            u && (l[i] = u);
          }
          for (var c = 0, d = Object.keys(l); c < d.length; c++)
            for (var C = d[c], f = 0, s = Object.keys(Qr); f < s.length; f++) {
              var p = s[f];
              C !== p &&
                -1 !== o.indexOf(p) &&
                l[C] &&
      ...
      return f(
        ...
        f(Pr, { nonce: v, style: O, fundingEligibility: C }),
        g && g.position === Un.TOP
          ? f(Jr, { markup: L, position: g.position })
          : null,
        V.map(function (n, e) {
          return f(zr, {
            content: a,
        ...
        R
          ...
          : null,
        _ ? f(Xr, { locale: h, nonce: v }) : null,
        g && g.position === Un.BOTTOM
          ? f(Jr, { markup: L, position: g.position })
          : null,
        f(Yr, { nonce: v })
      );
