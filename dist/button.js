    ...
    return Object(src["jsxToHTML"])(common["a" /* SVGCardLogo */], {
        ...
        render: function render() {
            return Object(src["jsxToHTML"])(
                ...
                Object(src["jsxToHTML"])('path', { d: 'M38.333 24H1.667C.75 24 0 23.28 0 22.4V1.6C0 .72.75 0 1.667 0h36.666C39.25 0 40 .72 40 1.6v20.8c0 .88-.75 1.6-1.667 1.6z', fill: 'rgb(20, 119, 190)' }),
                Object(src["jsxToHTML"])('path', { d: 'M6.26 12.32h2.313L7.415 9.66M27.353 9.977h-3.738v1.23h3.666v1.384h-3.675v1.385h3.821v1.005c.623-.77 1.33-1.466 2.025-2.235l.707-.77c-.934-1.004-1.87-2.08-2.804-3.075v1.077z', fill: 'rgb(255, 255, 255)' }),
                Object(src["jsxToHTML"])('path', { d: 'M38.25 7h-5.605l-1.328 1.4L30.072 7H16.984l-1.017 2.416L14.877 7h-9.58L1.25 16.5h4.826l.623-1.556h1.4l.623 1.556H29.99l1.327-1.483 1.328 1.483h5.605l-4.36-4.667L38.25 7zm-17.685 8.1h-1.557V9.883L16.673 15.1h-1.33L13.01 9.883l-.084 5.217H9.73l-.623-1.556h-3.27L5.132 15.1H3.42l2.884-6.772h2.42l2.645 6.233V8.33h2.646l2.107 4.51 1.868-4.51h2.575V15.1zm14.727 0h-2.024l-2.024-2.26-2.023 2.26H22.06V8.328H29.53l1.795 2.177 2.024-2.177h2.025L32.26 11.75l3.032 3.35z', fill: 'rgb(255, 255, 255)' })
            );
        }
    });
}
    ...
    return Object(src["jsxToHTML"])(common["a" /* SVGCardLogo */], {
        ...
        render: function render() {
            return Object(src["jsxToHTML"])(
                'svg',
                { width: '40', height: '24', viewBox: '0 0 40 24', preserveAspectRatio: 'xMinYMin meet', xmlns: 'http://www.w3.org/2000/svg' },
                Object(src["jsxToHTML"])('path', { d: 'M38.333 24H1.667C.75 24 0 23.28 0 22.4V1.6C0 .72.75 0 1.667 0h36.666C39.25 0 40 .72 40 1.6v20.8c0 .88-.75 1.6-1.667 1.6z', fill: 'rgb(17, 49, 82)' }),
                ...
                Object(src["jsxToHTML"])(
                    ...
                    Object(src["jsxToHTML"])(
                        ...
                        Object(src["jsxToHTML"])('stop', { offset: '0', 'stop-color': '#F89F21' }),
                        Object(src["jsxToHTML"])('stop', { offset: '0.2502', 'stop-color': '#F79A23' }),
                        Object(src["jsxToHTML"])('stop', { offset: '0.5331', 'stop-color': '#F78E22' }),
                        Object(src["jsxToHTML"])('stop', { offset: '0.6196', 'stop-color': '#F68721' }),
                        Object(src["jsxToHTML"])('stop', { offset: '0.7232', 'stop-color': '#F48220' }),
                        Object(src["jsxToHTML"])('stop', { offset: '1', 'stop-color': '#F27623' })
                    ),
                    ...
                    Object(src["jsxToHTML"])(
                        ...
                        Object(src["jsxToHTML"])('stop', { offset: '0', 'stop-color': '#F68721', 'stop-opacity': '0' }),
                        Object(src["jsxToHTML"])('stop', { offset: '0.3587', 'stop-color': '#E27027', 'stop-opacity': '0.2704' }),
                        Object(src["jsxToHTML"])('stop', { offset: '0.703', 'stop-color': '#D4612C', 'stop-opacity': '0.5299' }),
                        Object(src["jsxToHTML"])('stop', { offset: '0.9816', 'stop-color': '#D15D2D', 'stop-opacity': '0.74' })
                    ),
                ...
                Object(src["jsxToHTML"])(
                    ...
                    Object(src["jsxToHTML"])(
                        ...
                        Object(src["jsxToHTML"])(
                            'g',
                            null,
                            Object(src["jsxToHTML"])('path', { d: 'M13,38c20.1,0,40,0,40,0c1.7,0,3-1.3,3-3V18C56,18,51.2,31.8,13,38z', fill: 'rgb(255, 129, 38)' })
                        )
                    )
                )
            );
    ...
    return Object(src["jsxToHTML"])(common["a" /* SVGCardLogo */], {
        ...
        render: function render() {
            return Object(src["jsxToHTML"])(
                'svg',
                { width: '40', height: '24', viewBox: '0 0 40 24', preserveAspectRatio: 'xMinYMin meet', xmlns: 'http://www.w3.org/2000/svg' },
                Object(src["jsxToHTML"])('path', { d: 'M38.333 24H1.667C.75 24 0 23.28 0 22.4V1.6C0 .72.75 0 1.667 0h36.666C39.25 0 40 .72 40 1.6v20.8c0 .88-.75 1.6-1.667 1.6z', fill: 'rgb(21, 21, 21)' }),
                Object(src["jsxToHTML"])('path', { 'class': 'st0', d: 'M 9.229 8.55 C 9.592 8.431 9.977 8.365 10.382 8.365 C 12.14 8.365 13.602 9.613 13.939 11.268 L 16.427 10.762 C 15.855 7.946 13.365 5.824 10.379 5.824 C 9.693 5.824 9.037 5.935 8.42 6.142 L 9.229 8.55 Z', fill: 'rgb(255, 205, 5)' }),
                Object(src["jsxToHTML"])('path', { 'class': 'st1', d: 'M 6.292 16.616 L 7.973 14.716 C 7.221 14.052 6.749 13.08 6.749 11.999 C 6.749 10.917 7.221 9.945 7.973 9.279 L 6.292 7.38 C 5.015 8.51 4.209 10.16 4.209 11.999 C 4.209 13.836 5.019 15.488 6.292 16.616', fill: 'rgb(0, 164, 224)' }),
                Object(src["jsxToHTML"])('path', { 'class': 'st2', d: 'M 13.939 12.723 C 13.602 14.379 12.136 15.626 10.382 15.626 C 9.977 15.626 9.592 15.562 9.229 15.442 L 8.422 17.849 C 9.039 18.055 9.698 18.167 10.382 18.167 C 13.365 18.167 15.855 16.05 16.427 13.235 L 13.939 12.723 Z', fill: 'rgb(239, 66, 35)' }),
                ...
                Object(src["jsxToHTML"])('path', { d: 'M 27.77 7.466 L 27.77 14.673 L 28.891 15.13 L 28.254 16.614 L 27.018 16.1 C 26.742 15.979 26.552 15.797 26.409 15.588 C 26.272 15.377 26.171 15.085 26.171 14.698 L 26.171 7.466 L 27.77 7.466 Z', fill: 'rgb(255, 255, 255)' }),
                Object(src["jsxToHTML"])(
                    'g',
                    { transform: 'matrix(0.037801, 0, 0, 0.037801, 1.0913, 0.089785)' },
                    Object(src["jsxToHTML"])('path', { d: 'M782.7,337.2c0-16.2,7.2-30.8,18.5-40.7l-30.4-33.9c-20.6,18.2-33.6,44.9-33.6,74.6c0,29.7,12.9,56.4,33.6,74.7l30.4-34 C789.8,367.9,782.6,353.4,782.7,337.2z', fill: 'rgb(255, 255, 255)' }),
                    Object(src["jsxToHTML"])('path', { d: 'M836.7,391.4c-6,0-11.8-1-17.1-2.8L805,431.7c9.9,3.3,20.6,5.1,31.6,5.2c48.2,0,88.4-34.1,97.7-79.6l-44.7-9.1 C884.6,372.9,862.8,391.4,836.7,391.4z', fill: 'rgb(255, 255, 255)' }),
                    Object(src["jsxToHTML"])('path', { d: 'M836.8,237.6c-11,0-21.7,1.8-31.6,5.1l14.4,43.2c5.4-1.8,11.2-2.8,17.1-2.8c26.2,0,48,18.6,53,43.3l44.7-9.1 C925.2,272,885,237.7,836.8,237.6z', fill: 'rgb(255, 255, 255)' })
                )
            );
        }
    });
    ...
    return Object(src["jsxToHTML"])(common["a" /* SVGCardLogo */], {
        ...
        render: function render() {
            return Object(src["jsxToHTML"])(
                'svg',
                { width: '40', height: '24', viewBox: '0 0 40 24', preserveAspectRatio: 'xMinYMin meet', xmlns: 'http://www.w3.org/2000/svg' },
                Object(src["jsxToHTML"])('path', { d: 'M0 1.927C0 .863.892 0 1.992 0h36.016C39.108 0 40 .863 40 1.927v20.146C40 23.137 39.108 24 38.008 24H1.992C.892 24 0 23.137 0 22.073V1.927z', fill: 'rgb(243, 97, 24)' }),
    ...
    return Object(src["jsxToHTML"])(common["a" /* SVGCardLogo */], {
        ...
        render: function render() {
            return Object(src["jsxToHTML"])(
                'svg',
                { width: '40', height: '24', viewBox: '0 0 40 24', preserveAspectRatio: 'xMinYMin meet', xmlns: 'http://www.w3.org/2000/svg' },
                Object(src["jsxToHTML"])('path', { d: 'M0 1.927C0 .863.892 0 1.992 0h36.016C39.108 0 40 .863 40 1.927v20.146C40 23.137 39.108 24 38.008 24H1.992C.892 24 0 23.137 0 22.073V1.927z', fill: 'rgb(33, 86, 154)' }),
