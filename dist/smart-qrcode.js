window.spbQRCode = function(modules) {
    ...
    function InstructionIcon(_ref) {
        var _ref$stylingClass = _ref.stylingClass;
        return preact_module_a("svg", {
            className: void 0 === _ref$stylingClass ? "instruction-icon" : _ref$stylingClass,
            width: "68",
            height: "46",
            viewBox: "0 0 68 46",
            fill: "none",
    ...
    function DemoControls(_ref2) {
        var processState = _ref2.processState, errorMessage = _ref2.errorMessage, isError = _ref2.isError, setState_error = _ref2.setState_error, setState_scanned = _ref2.setState_scanned, setState_authorized = _ref2.setState_authorized, setState_default = _ref2.setState_default, setErrorMessage = _ref2.setErrorMessage;
        return preact_module_a("div", {
            id: "controls"
        }, preact_module_a("style", {
            nonce: _ref2.cspNonce
        }, " ", "\n                    #controls {\n                        position: fixed;\n                        bottom: 1rem;\n                        left: 1rem;\n                        padding: 1rem;\n                        border: 1px solid #888C94;\n                        display: flex;\n                        flex-wrap: wrap;\n                    }\n                    #controls button {min-width: 48px;}\n                    #controls > * {margin: 0 0.5rem;}\n                    #controls div {display: flex; flex-direction: column;}\n                "), preact_module_a("button", {
            type: "button",
            disabled: isError(),
            onClick: function() {
                switch (processState) {
            ...
            authorized: "Reset",
            scanned: "Auth"
        }[processState || "null"]), preact_module_a("button", {
            type: "button",
            onClick: function() {
                return setState_error();
            }
        }, "Show Error"), preact_module_a("div", null, preact_module_a("button", {
            type: "button",
            onClick: function() {
                setState_error();
            }
        }, "Set Error Value"), preact_module_a("input", {
            type: "text",
            id: "errorMsg",
            value: errorMessage,
            onChange: function(e) {
                return setErrorMessage(e.target.value);
            }
        })), preact_module_a("button", {
            type: "button",
            style: {
    ...
    function QRCard(_ref3) {
        var cspNonce = _ref3.cspNonce, svgString = _ref3.svgString, demo = _ref3.demo;
        var _useState = hooks_module_l(null), processState = _useState[0], setProcessState = _useState[1];
        var _useState2 = hooks_module_l(null), errorMessage = _useState2[0], setErrorMessage = _useState2[1];
        var isError = function() {
            return "error" === processState;
        };
        var setState_default = function() {
            return setProcessState(null);
        };
        ...
        }, isError() ? preact_module_a(ErrorMessage, {
            message: errorMessage,
            resetFunc: function() {
                return setState_default();
            }
        }) : preact_module_a("div", {
            id: "front-view",
            className: "card"
        ...
        }, "Venmo account authorized"))), demo ? preact_module_a(DemoControls, {
            cspNonce: cspNonce,
            processState: processState,
            isError: isError,
            setState_error: function() {
                return setProcessState("error");
            },
            setState_scanned: function() {
                return setProcessState("scanned");
            },
            setState_authorized: function() {
                return setProcessState("authorized");
            },
            setState_default: setState_default,
            setErrorMessage: setErrorMessage
        }) : null);
    }
    function renderQRCode(_ref4) {
        var _ref4$cspNonce = _ref4.cspNonce, cspNonce = void 0 === _ref4$cspNonce ? "" : _ref4$cspNonce, _ref4$demo = _ref4.demo, demo = void 0 !== _ref4$demo && _ref4$demo;
        var PropedCard = preact_module_a(QRCard, {
            cspNonce: cspNonce,
            svgString: _ref4.svgString,
            demo: demo
        });
        !function(l, u, i) {
            var o, e;
            ...
            T(e, l);
        }(demo ? function(component, cspNonce) {
            return preact_module_a(y, null, preact_module_a("style", {
                nonce: cspNonce
            }, "html{background-color: rgba(0, 0, 0, 0.4);}"), preact_module_a("div", {
                style: "\n                background: #2F3033;\n                box-shadow: 0px 0px 8px rgba(0, 0, 0, 0.4);\n                border-radius: 16px;                        \n                width: 720px;\n                height: 480px;  \n                display: flex;\n                align-items: center;\n                justify-content: center;\n                flex-direction: column;\n                position: relative;\n            }\n            "
            }, component));
        }(PropedCard, cspNonce) : PropedCard, function() {
