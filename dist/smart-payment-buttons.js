window.spb = function(modules) {
    ...
    "./src/button/index.js": function(module, __webpack_exports__, __webpack_require__) {
        ...
        function validatePaymentMethod(_ref6) {
            ...
            _headers10["x-app-version"] = "2.0.351", _headers10);
            var paymentSource = {
                token: {
                    id: paymentMethodID,
                    type: "NONCE"
                        ...
                        return promise_ZalgoPromise.try((function() {
                            ...
                            return window.xprops.forceNativeDirectAppSwitch || !window.xprops.forceNativePopupAppSwitch && isAndroidChrome() ? function(_ref17) {
                                ...
                                var awaitRedirectListener = listen(popupWin, getNativePopupDomain(), "awaitRedirect", (function(_ref19) {
                                    var pageUrl = _ref19.data.pageUrl;
        ...
        function setupButton(opts) {
            ...
            var setupButtonLogsTask = function(_ref) {
                ...
                logger.addTrackingBuilder((function() {
                    ...
                    _ref2.button_version = "2.0.351", _ref2.button_correlation_id = buttonCorrelationID, 
