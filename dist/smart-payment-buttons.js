window.spb = function(modules) {
    ...
    "./src/button/index.js": function(module, __webpack_exports__, __webpack_require__) {
        ...
        function validatePaymentMethod(_ref7) {
            ...
            _headers11["x-app-version"] = "5.0.15", _headers11);
            var paymentSource = {
                token: {
                    id: paymentMethodID,
                    type: "NONCE"
        ...
        var PAYMENT_FLOWS = [ {
            ...
            init: function(_ref6) {
                ...
                var onCancelCallback = function() {
                    ...
                    return promise_ZalgoPromise.all([ onCancel(), close() ]).then((function() {
                        return {
                            buttonSessionID: buttonSessionID
                        };
                    }));
                ...
                var onErrorCallback = function(_ref13) {
                    ...
                    return promise_ZalgoPromise.all([ onError(new Error(message)), close() ]).then((function() {
                        return {
                            buttonSessionID: buttonSessionID
                        };
                    }));
        ...
        function setupButton(opts) {
            ...
            var setupButtonLogsTask = function(_ref) {
                ...
                logger.addTrackingBuilder((function() {
                    ...
                    _ref3.button_version = "5.0.15", _ref3.button_correlation_id = buttonCorrelationID, 
