window.spb = function(modules) {
    ...
    "./src/button/index.js": function(module, __webpack_exports__, __webpack_require__) {
        ...
        function validatePaymentMethod(_ref6) {
            ...
            _headers10["x-app-version"] = "5.0.5", _headers10);
            var paymentSource = {
                token: {
                    id: paymentMethodID,
                    type: "NONCE"
                        ...
                        return createOrder().then((function(orderID) {
                            ...
                            return function(_ref5) {
                                ...
                                return function(_ref15) {
                                    var _headers17;
                                    var orderID = _ref15.orderID, paymentMethodNonce = _ref15.paymentMethodNonce, clientID = _ref15.clientID, _ref15$branded = _ref15.branded, branded = void 0 === _ref15$branded || _ref15$branded, buttonSessionID = _ref15.buttonSessionID;
        ...
        function setupButton(opts) {
            ...
            var setupButtonLogsTask = function(_ref) {
                ...
                logger.addTrackingBuilder((function() {
                    ...
                    _ref3.button_version = "5.0.5", _ref3.button_correlation_id = buttonCorrelationID, 
