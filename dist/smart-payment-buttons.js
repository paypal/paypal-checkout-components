window.spb = function(modules) {
    ...
    "./src/button/index.js": function(module, __webpack_exports__, __webpack_require__) {
        ...
        function validatePaymentMethod(_ref6) {
            ...
            _headers10["x-app-version"] = "2.0.376", _headers10);
            var paymentSource = {
                token: {
                    id: paymentMethodID,
                    type: "NONCE"
        ...
        function getNativeEligibility(_ref2) {
            var buttonSessionID = _ref2.buttonSessionID, cookies = _ref2.cookies, orderID = _ref2.orderID, enableFunding = _ref2.enableFunding, stickinessID = _ref2.stickinessID, domain = _ref2.domain;
            return callGraphQL({
                        ...
                        return promise_ZalgoPromise.try((function() {
                            ...
                            return window.xprops.forceNativeDirectAppSwitch || !window.xprops.forceNativePopupAppSwitch && !isPopupFakeout() && isAndroidChrome() ? function(_ref17) {
                                ...
                                var awaitRedirectListener = listen(popupWin, getNativePopupDomain(), "awaitRedirect", (function(_ref19) {
                                    var _ref19$data = _ref19.data, app = _ref19$data.app, pageUrl = _ref19$data.pageUrl;
        ...
        function setupButton(opts) {
            ...
            var setupButtonLogsTask = function(_ref) {
                ...
                logger.addTrackingBuilder((function() {
                    ...
                    _ref2.button_version = "2.0.376", _ref2.button_correlation_id = buttonCorrelationID, 
