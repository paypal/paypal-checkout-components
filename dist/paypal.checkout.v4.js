(function webpackUniversalModuleDefinition(root, factory) {
  ...
  \**********************/
    function(module, exports, __webpack_require__) {
        ...
        var _setup = __webpack_require__(/*! ./setup */ 83);
  ...
  \***************************/
    function(module, exports, __webpack_require__) {
        ...
        function initLogger() {
            ...
            var logUrl = _config.config.env && _config.config.loggerUrls[_config.config.env] || _config.config.loggerUrls.production;
  ...
  \*****************************/
    function(module, exports, __webpack_require__) {
        ...
        var _src = __webpack_require__(/*! xcomponent/src */ 4);
        var _src2 = _interopRequireDefault(_src);
        var _eligibility = __webpack_require__(/*! ./eligibility */ 82);
        var _lib = __webpack_require__(/*! ../lib */ 66);
        var _config = __webpack_require__(/*! ../config */ 61);
        function _interopRequireDefault(obj) {
            return obj && obj.__esModule ? obj : {
        ...
        var buttonJS = void 0;
        var env = "production";
        var LOG_PREFIX = "ppxo_legacy";
        function logDebug(event) {
            var payload = arguments.length <= 1 || arguments[1] === undefined ? {} : arguments[1];
            _client2["default"].debug(LOG_PREFIX + "_" + event, payload);
        }
        function logInfo(event) {
            var payload = arguments.length <= 1 || arguments[1] === undefined ? {} : arguments[1];
            _client2["default"].info(LOG_PREFIX + "_" + event, payload);
        }
        function logWarning(event) {
            var payload = arguments.length <= 1 || arguments[1] === undefined ? {} : arguments[1];
            _client2["default"].warn(LOG_PREFIX + "_" + event, payload);
        }
        function logError(event) {
            var payload = arguments.length <= 1 || arguments[1] === undefined ? {} : arguments[1];
            _client2["default"].error(LOG_PREFIX + "_" + event, payload);
        }
        function loadButtonJS() {
            ...
            buttonJS = (0, _lib.loadScript)(BUTTON_JS_URL);
            return buttonJS.then(function(result) {
                logDebug("buttonjs_load_success");
                return result;
            })["catch"](function(err) {
                logError("buttonjs_load_error", {
                    error: err.stack || err.toString()
                });
                throw err;
            });
        ...
        function getPaymentToken(resolve, reject) {
            ...
            window.paypal.checkout.startFlow = function(token) {
                logDebug("paymenttoken_startflow", {
                    token: token
                });
                reset();
                var ecToken = parseToken(token);
                if (!ecToken) {
                    logError("paymenttoken_startflow_notoken", {
                        token: token
                    });
                ...
                if (!(0, _eligibility.isEligible)()) {
                    logDebug("paymenttoken_startflow_ineligible", {
                        token: ecToken
                    });
                    return redirect(getFullpageRedirectUrl(token));
                }
                if (matchToken(token)) {
                    logDebug("paymenttoken_startflow_tokenpassed", {
                        token: token
                    });
                } else {
                    logDebug("paymenttoken_startflow_urlpassed", {
                        token: token
                    });
                    _this.updateProps({
                        url: token
        ...
        function drawButton(id, options, btnContainer) {
            var buttonDom = window.paypal.button.create(id, {
                lc: options.lc || _config.config.locale.lang + "_" + _config.config.locale.country,
  ...
  \**********************/
    function(module, exports, __webpack_require__) {
        ...
        var _client2 = _interopRequireDefault(_client);
        var _config = __webpack_require__(/*! ./config */ 61);
        var _bridge = __webpack_require__(/*! ./bridge */ 84);
        var _lib = __webpack_require__(/*! ./lib */ 66);
        function _interopRequireDefault(obj) {
            return obj && obj.__esModule ? obj : {
                "default": obj
        ...
        function setup(options) {
            ...
            _config.config.state = options.state || _config.config.state;
