...
function(module, exports, __webpack_require__) {
    ...
    var version = exports.version = "4.0.10";
}, /*!*********************************!*\
...
function(module, exports, __webpack_require__) {
    ...
    var PayPalButton = exports.PayPalButton = _src2["default"].create({
        ...
        name: "ppbutton",
        get version() {
            return _config.config.ppobjects ? "4.0.10" : "4.0.10";
        },
...
function(module, exports, __webpack_require__) {
    ...
    var config = exports.config = {
        scriptUrl: "//www.paypalobjects.com/api/" + "paypal.checkout.v4.0.10.js",
        ppobjects: false,
        env: "production",
...
function(module, exports, __webpack_require__) {
    ...
    function getFullpageRedirectUrl(token) {
        ...
        var ecToken = (0, _util.matchToken)(token);
        if (!ecToken) {
    ...
    function getPaymentToken(resolve, reject) {
        ...
        window.paypal.checkout.startFlow = function(token) {
            ...
            if (!ecToken) {
                (0, _log.logWarning)("paymenttoken_startflow_notoken", {
                    token: token
                });
                ecToken = _src2["default"].CONSTANTS.PROP_DEFER_TO_URL;
            }
...
function(module, exports, __webpack_require__) {
    ...
    function setupBridge(env, bridgeUrl) {
        ...
        var version = _config.config.ppobjects ? "4.0.10" : "4.0.10";
