this["ppxo"] = function(modules) {
    ...
    0: function(module, exports, __webpack_require__) {
        ...
        if (window.paypal && window.paypal.version === "4.0.15") {
    ...
    "./src/interface/public.js": function(module, exports, __webpack_require__) {
        ...
        var version = exports.version = "4.0.15";
        module.exports["default"] = module.exports;
    },
            ...
            _createClass(ParentComponent, [ {
                ...
                value: function render(element) {
                    ...
                    return this.tryInit(function() {
                        ...
                        tasks.linkUrl = _promise.SyncPromise.all([ tasks.getDomain, tasks.open ]).then(function(_ref4) {
                            var _ref5 = _slicedToArray(_ref4, 1);
                            var domain = _ref5[0];
                            return _src2["default"].linkUrl(_this7.window, domain);
                        });
                        tasks.listen = _promise.SyncPromise.all([ tasks.getDomain, tasks.open ]).then(function(_ref6) {
                        ...
                        if (loadUrl) {
                            ...
                            tasks.loadUrl = _promise.SyncPromise.all([ tasks.buildUrl, tasks.openBridge, tasks.createComponentTemplate ]).then(function(_ref8) {
    ...
    "./src/config/config.js": function(module, exports, __webpack_require__) {
        ...
        var config = exports.config = {
            scriptUrl: "//www.paypalobjects.com/api/" + "checkout.4.0.15.js",
            ...
            get bridgeUri() {
                return "/webapps/hermes/component-meta?xcomponent=1&version=" + (config.ppobjects ? "4.0.15" : "4.0.15");
            },
    ...
    "./src/components/button/component.js": function(module, exports, __webpack_require__) {
        ...
        var Button = exports.Button = _src2["default"].create({
            ...
            get version() {
                return _config.config.ppobjects ? "4.0.15" : "4.0.15";
            },
            get domains() {
