...
module.exports = function(config) {
    ...
    config.set({
        ...
        webpackMiddleware: {
            noInfo: process.env.WEBPACK_DEBUG ? false : true,
            stats: process.env.WEBPACK_DEBUG ? true : false
        },
        ...
        logLevel: process.env.KARMA_DEBUG ? config.LOG_DEBUG : config.LOG_WARN,
