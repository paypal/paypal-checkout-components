...
test(`Animation for fadeout logo and show label text should be applied when there is valid personalization`, async () => {
    const { Buttons } = await getButtonScript();
    ...
    const animationContainer = buttonHTML.match('data-animation-experiment');
    const animationScript = buttonHTML.match('fadeout-logo-show-label-animation-container');
